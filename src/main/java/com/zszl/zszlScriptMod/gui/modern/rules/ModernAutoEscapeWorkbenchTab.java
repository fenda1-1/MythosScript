...
public final class ModernAutoEscapeWorkbenchTab implements ModernSettingsTab {
    ...
    public boolean mouseClicked(int mouseX, int mouseY, int button) {
        ...
        if (navigationScrollbar.beginDrag(mouseX, mouseY)) {
            return true;
        }
    ...
    private ModernSettingsTab buildEditor(final AutoEscapeRule rule) {
        ModernFormSettingsTab.Builder<AutoEscapeRule> builder = ModernFormSettingsTab.builder(
                ...
                .footerVisible(false)
                .headerToggle(bool(() -> rule.enabled, value -> rule.enabled = value), "gui.modern.escape.u047")
                ...
                .choice("gui.modern.escape.u043", "gui.modern.escape.u044",
                ...
                ;
        builder.custom(new AutoFollowTargetPanel(ENTITY_TYPES, rule.entityTypes::contains,
                (key, value) -> toggleToken(rule.entityTypes, key, value)));
        builder.decimal("gui.modern.escape.u049", "gui.modern.escape.u050", number(() -> (float) rule.detectionRange, value -> rule.detectionRange = value), 1, 128)
                ...
                .custom(new AutoFollowCollectionPanel(AutoFollowCollectionPanel.Mode.NAMES, ModernFormI18n.tr("gui.modern.escape.u064"), list(rule.nameWhitelist)::get, list(rule.nameWhitelist)::set))
