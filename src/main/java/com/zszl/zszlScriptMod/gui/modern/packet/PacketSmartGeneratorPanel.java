...
final class PacketSmartGeneratorPanel extends PacketPanelBase {
    ...
    @Override protected void drawBody(FontRenderer font, ModernMainLayout.Rect area, int mx, int my) {
        ...
        for (int i = sampleScroll; i < state.samples().size() && i < sampleScroll + sampleRows; i++) {
            ...
            ModernUiRenderer.drawSubtlePanel(left.x + 8, rowY, ModernHoverScrollbar.contentWidth(left.width - 16), 20, 3, i == selectedSample ? ModernUiRenderer.SELECTED_SURFACE : hover ? ModernUiRenderer.SURFACE_HOVER : ModernUiRenderer.SHELL_RAISED, i == selectedSample ? ModernUiRenderer.ACCENT : ModernUiRenderer.BORDER_SUBTLE);
        ...
        for (int i = proposalScroll; i < analysis.getProposals().size() && i < proposalScroll + proposalRows; i++) {
            ...
            ModernUiRenderer.drawSubtlePanel(proposalBounds.x + 8, rowY, ModernHoverScrollbar.contentWidth(proposalBounds.width - 8), 58, 3, selected ? ModernUiRenderer.SELECTED_SURFACE : hover ? ModernUiRenderer.SURFACE_HOVER : ModernUiRenderer.SHELL_RAISED, selected ? ModernUiRenderer.ACCENT : ModernUiRenderer.BORDER_SUBTLE);
    ...
    private void drawCompactBody(FontRenderer font, ModernMainLayout.Rect area, int mx, int my, int x, int top,
        ...
        for (int i = sampleScroll; i < state.samples().size() && i < sampleScroll + sampleRows; i++) {
            ...
            ModernUiRenderer.drawSubtlePanel(left.x + 8, rowY, ModernHoverScrollbar.contentWidth(width - 16), 20, 3,
                    i == selectedSample ? ModernUiRenderer.SELECTED_SURFACE : hover ? ModernUiRenderer.SURFACE_HOVER : ModernUiRenderer.SHELL_RAISED,
        ...
        for (int i = proposalScroll; i < analysis.getProposals().size() && i < proposalScroll + proposalRows; i++) {
            ...
            ModernUiRenderer.drawSubtlePanel(proposalBounds.x + 8, rowY, ModernHoverScrollbar.contentWidth(proposalBounds.width - 8), 58, 3,
                    selected ? ModernUiRenderer.SELECTED_SURFACE : ModernUiRenderer.SHELL_RAISED,
