...
public final class ModernFormBuilder<S> {
    ...
    public ModernFormBuilder<S> custom(ModernFormWidget widget) {
        return append(item(ModernFormDefinition.ItemType.CUSTOM, "", "", widget, "", "", "", 1,
                0, 0, 0, 0, ModernFormSettingsTab.ActionStyle.SECONDARY, null, null));
    }
