...
public final class ModernFormSettingsTab<S> implements ModernSettingsTab {
    ...
    public static final class Builder<S> {
        ...
        public Builder<S> custom(com.zszl.zszlScriptMod.gui.modern.form.ModernFormWidget widget) {
            delegate.custom(widget);
            return this;
        }
    ...
    public ModernFormSettingsTab<S> sectionPages(com.zszl.zszlScriptMod.gui.modern.form.RuleSectionState state) {
        panel.setSectionPages(state);
        return this;
    }

    public ModernFormSettingsTab<S> rememberScroll(com.zszl.zszlScriptMod.gui.modern.form.RuleSectionState state) {
        panel.rememberScroll(state);
        return this;
    }
    ...
    /** Builds selectable options from existing model values without allowing free-form input. */
    public static List<ChoiceOption<String>> stringOptions(Iterable<String> values) {
        List<ChoiceOption<String>> result = new ArrayList<>();
        if (values != null) {
            for (String value : values) {
                ...
                result.add(option(normalized, normalized));
            }
        }
        return result;
    }
    ...
    public boolean handleMouseWheel(int wheel, int mouseX, int mouseY) {
        return panel.handleMouseWheel(wheel, mouseX, mouseY);
    }
