    ...
    public void onPlayerUpdate(PlayerUpdateEvent event) {
        ...
        switch (event.getState()) {
            case PRE: {
                ...
                boolean decoupledFreeLook = shouldDecoupleMovementFromVisualYaw();
                boolean humanLikeVisualControl = !decoupledFreeLook
                ...
                boolean smoothLookVisualControl = !decoupledFreeLook
                        && !this.killAuraVisualControlThisTick
