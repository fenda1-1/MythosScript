...
public final class Settings {
     ...
     * ascent. Extended ascents require a continuous supported step column;
     * isolated floating platforms are not treated as steps. Values are clamped
     * to the inclusive range 1 to 100.
     */
    ...
    /**
     * Allow Baritone to use the player's existing flight capability for pathing.
     * This setting never grants flight or changes the game mode.
     */
    public final Setting<Boolean> allowFlightPathing = new Setting<>(false);
    public final Setting<Boolean> flightDirectLine = new Setting<>(true);
    public final Setting<Integer> flightClearance = new Setting<>(1);
    public final Setting<Integer> flightCorridorWidth = new Setting<>(3);
    public final Setting<Double> flightCorridorCornerExtension = new Setting<>(0.5D);
    public final Setting<Boolean> flightEntityCorridor = new Setting<>(false);
    public final Setting<Double> entityCorridorOpacity = new Setting<>(0.0D);
    public final Setting<Integer> flightMinAltitude = new Setting<>(1);
    public final Setting<Integer> flightMaxAltitude = new Setting<>(256);
    public final Setting<Double> flightSpeed = new Setting<>(0.9D);
    ...
    /**
     * The function that is called when Baritone will log. The mod integration
     * routes these records to the in-game debug terminal instead of chat. This function can be added to
    ...
    public final Setting<Consumer<ITextComponent>> logger = new Setting<>(
            msg -> DebugLogManager.appendExternal(DebugModule.BARITONE,
